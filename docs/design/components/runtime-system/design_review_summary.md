# Policy Runtime Design Summary (superseded)

> **Superseded.** This was the one-page summary of the pre-`ActionSource`
> design (`PolicyRuntime` as the entry point). The current design is
> [runtime_design.md](./runtime_design.md).
